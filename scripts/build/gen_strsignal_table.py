...
def gen_strsignal_table(input, output, full):
        ...
        with open(output, 'w') as outf:
            ...
            for symbol in symbols:
                if full:
                    ...
                    print(f'\t[{symbol}] = "{symbol}",', file=outf)
...
def parse_args():
    ...
    parser.add_argument(
        ...
        dest='full',
        required=False,
        help='Use full string for the strsignal API')
...
def main():
    args = parse_args()
    gen_strsignal_table(args.input, args.output, args.full)
