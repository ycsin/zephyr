...
/* exclude external sys/features.h */
#define _SYS_FEATURES_H

#if !defined(_POSIX_C_SOURCE) && defined(_XOPEN_SOURCE)
/* Currently Zephyr only supports POSIX.1-2017 */
...
#ifdef CONFIG_PIOLIBC
#define __ZEPHYR_VISIBLE 1
#endif

#if defined(_POSIX_C_SOURCE)
#define __POSIX_VISIBLE (_POSIX_VERSION - 0)
#endif

#if defined(_XOPEN_SOURCE)
#define __XSI_VISIBLE _XOPEN_VERSION
#endif
